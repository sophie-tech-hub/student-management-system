...
<html>
<head>
  <title>Manage Fee Records</title>
  <style>
      ...
      <?php else: ?>
        ...
        <tr>
          ...
          <td>
            ...
            <?php else: ?>
              <a href="add_fees.php?student_id=<?= $s['student_id'] ?>" class="btn-add">Add</a>
              <a href="edit_fees.php?fee_id=<?= $s['fee_id'] ?>" class="btn-edit" title="Edit fee record">Edit</a>
<a href="delete_fees.php?faculty=<?= $faculty ?>&year_of_study=<?= $year ?>&delete_id=<?= $s['fee_id'] ?>" class="btn-delete" title="Delete fee record" onclick="return confirm('Delete this fee record?');">Delete</a>
